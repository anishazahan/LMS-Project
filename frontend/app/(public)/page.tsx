      ...
      <section className="relative container pt-32 pb-20 md:pt-48 md:pb-32">
        <div className="mx-auto max-w-4xl text-center space-y-8 relative z-10">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            E-Study learns how you learn. Experience personalized curriculums,
            real-time AI mentoring, and dynamic content that adapts to your
            unique pace and goals.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button
              asChild
              size="lg"
              className="h-12 px-8 text-base shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all duration-300"
            >
              <Link href="/courses">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="h-12 px-8 text-base backdrop-blur-sm bg-background/50 border-primary/20 hover:bg-primary/10 transition-all duration-300"
            >
      ...
      <section className="relative container pb-20">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Our platform integrates cutting-edge AI to provide an unparalleled
            learning experience.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <Card
              key={i}
              className="group relative overflow-hidden bg-background/50 backdrop-blur-sm border-primary/10 hover:border-primary/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/10"
            >
